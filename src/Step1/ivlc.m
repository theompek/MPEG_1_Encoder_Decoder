...
%Den yparxei escape code tote d15b
   ...
   for step=2:16
       CodeBin= vlcStream(pos:pos+step-1);
      for j=1:size(d15b,1)
...
blockEnd =vlcStream(pos:pos+1);
if strcmp(blockEnd,'10') %bits telous
break;
end
